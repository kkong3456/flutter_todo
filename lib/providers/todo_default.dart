...
class TodoDefault {
  List<Todo> dummyTodos = [
    Todo(id: 1, title: '플러터 공부시작하기', description: '뽕 뽑는 플러터를 읽어 봅시다'),
    Todo(id: 2, title: '서점 가기', description: '뽕 뽑는 플러터를 사러가야쥐'),
    Todo(id: 3, title: '공원에서 운동하기', description: '집근처 공원에 가서 안정하게 운동하기'),
